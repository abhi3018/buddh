...
export const updateProfileInfo =  async(credentials) => {
  console.log("Updating profile info:", credentials);console.log(credentials);// return 10;
 const res = await axios.put("/api/users/updateProfileInfo", credentials);
  return res.data;
};
